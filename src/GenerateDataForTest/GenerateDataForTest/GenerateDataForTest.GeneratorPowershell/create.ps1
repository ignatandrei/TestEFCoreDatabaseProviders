...
$pathToModels = "../GenerateDataForTest.crats/src/Admin/Generated/Models/"+$nameContext
$pathToContext= "../GenerateDataForTest.crats/src/Admin/Generated/DB/"+$nameContext
...
function Generate{
    ...
    dotnet ef dbcontext scaffold $connection  -p $project -s $project $provider -v -f --no-pluralize --no-onconfiguring --use-database-names  --context $nameContext  --context-namespace Generated --namespace Generated --context-dir $pathToContext --output-dir $pathToModels  --prefix-output --force --json #--no-build
...
Generate "Models"  "../GenerateDataForTest.Models/Generated/" $project

Generate "Context"  "../GenerateDataForTest.Context/Generated/" $project

Generate "Controllers"  "../GenerateDataForTest.Controllers/Generated/" $project 

Generate "crats"  "../GenerateDataForTest.crats/src/Admin/Generated/" $project

Generate "angular"  "../GenerateDataForTest.Angular/src/app/Admin/Generated/" $project
