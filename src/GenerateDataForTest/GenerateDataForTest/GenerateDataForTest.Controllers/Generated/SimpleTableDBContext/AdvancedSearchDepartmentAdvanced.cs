...
public partial class AdvancedSearch_SimpleTableDBContext_DepartmentController : Controller
{
    private ISearchDataDepartment _search;
    public AdvancedSearch_SimpleTableDBContext_DepartmentController(ISearchDataDepartment search)
	{
        _search=search;
	}
    [HttpGet]
