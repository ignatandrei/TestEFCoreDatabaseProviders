...
public partial class SearchTbl_MONEY:  GeneratorFromDB.Search<eTbl_MONEYColumns,Tbl_MONEY>
{
    //private SimpleTablesMultipleData _context;
    //public SearchTbl_MONEY(SimpleTablesMultipleData context){
    //    _context= context;
    //}
public static SearchTbl_MONEY FromSearch(GeneratorFromDB.SearchCriteria sc, eTbl_MONEYColumns colToSearch, string value)
    {
   ...
   public override IOrderedQueryable<Tbl_MONEY> TransformToOrder(IQueryable<Tbl_MONEY> data){
        if(OrderBys == null || OrderBys.Length ==0){
            OrderBys =new GeneratorFromDB.OrderBy<eTbl_MONEYColumns>[1];
            OrderBys[0]= new GeneratorFromDB.OrderBy<eTbl_MONEYColumns>()
            {
                //maybe find PK ...
                FieldName = eTbl_MONEYColumns.ID,
                Asc=false
            };
        }
        var order = OrderBys[0]!;
        IOrderedQueryable<Tbl_MONEY> ret;
        //TODO: maybe utilize EF.Property ? 
        switch(order.FieldName){
                    case eTbl_MONEYColumns.ID:
                if(order.Asc)
                ...
                break;
                    ...
                    case eTbl_MONEYColumns.DataColumn:
                if(order.Asc)
                ...
                break;
                    ...
                    default:
                throw new ArgumentException(" cannot order Tbl_MONEY by "+ order.FieldName);
    ...
    public override  IQueryable<Tbl_MONEY> TransformToWhere(IQueryable<Tbl_MONEY> data){
        if(SearchFields == null || SearchFields.Length ==0)        
            return data;
        var returnValue = data;
        foreach(var s in SearchFields){
            switch(s.FieldName ){
                case eTbl_MONEYColumns.None :
                    continue;
            ...
            case eTbl_MONEYColumns.ID:
                ...
                if(s.Value == null)
        {
                            throw new ArgumentException("Tbl_MONEY.ID cannot be null");
