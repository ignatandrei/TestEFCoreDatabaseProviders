...
public partial class SearchTbl_XML:  GeneratorFromDB.Search<eTbl_XMLColumns,Tbl_XML>
{
    //private SimpleTablesMultipleData _context;
    //public SearchTbl_XML(SimpleTablesMultipleData context){
    //    _context= context;
    //}
public static SearchTbl_XML FromSearch(GeneratorFromDB.SearchCriteria sc, eTbl_XMLColumns colToSearch, string value)
    {
   ...
   public override IOrderedQueryable<Tbl_XML> TransformToOrder(IQueryable<Tbl_XML> data){
        if(OrderBys == null || OrderBys.Length ==0){
            OrderBys =new GeneratorFromDB.OrderBy<eTbl_XMLColumns>[1];
            OrderBys[0]= new GeneratorFromDB.OrderBy<eTbl_XMLColumns>()
            {
                //maybe find PK ...
                FieldName = eTbl_XMLColumns.ID,
                Asc=false
            };
        }
        var order = OrderBys[0]!;
        IOrderedQueryable<Tbl_XML> ret;
        //TODO: maybe utilize EF.Property ? 
        switch(order.FieldName){
                    case eTbl_XMLColumns.ID:
                if(order.Asc)
                ...
                break;
                    ...
                    case eTbl_XMLColumns.DataColumn:
                if(order.Asc)
                ...
                break;
                    ...
                    default:
                throw new ArgumentException(" cannot order Tbl_XML by "+ order.FieldName);
    ...
    public override  IQueryable<Tbl_XML> TransformToWhere(IQueryable<Tbl_XML> data){
        if(SearchFields == null || SearchFields.Length ==0)        
            return data;
        var returnValue = data;
        foreach(var s in SearchFields){
            switch(s.FieldName ){
                case eTbl_XMLColumns.None :
                    continue;
            ...
            case eTbl_XMLColumns.ID:
                ...
                if(s.Value == null)
        {
                            throw new ArgumentException("Tbl_XML.ID cannot be null");
