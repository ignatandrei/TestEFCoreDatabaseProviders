...
public partial class SearchTbl_NCHAR:  GeneratorFromDB.Search<eTbl_NCHARColumns,Tbl_NCHAR>
{
    //private SimpleTablesMultipleData _context;
    //public SearchTbl_NCHAR(SimpleTablesMultipleData context){
    //    _context= context;
    //}
public static SearchTbl_NCHAR FromSearch(GeneratorFromDB.SearchCriteria sc, eTbl_NCHARColumns colToSearch, string value)
    {
   ...
   public override IOrderedQueryable<Tbl_NCHAR> TransformToOrder(IQueryable<Tbl_NCHAR> data){
        if(OrderBys == null || OrderBys.Length ==0){
            OrderBys =new GeneratorFromDB.OrderBy<eTbl_NCHARColumns>[1];
            OrderBys[0]= new GeneratorFromDB.OrderBy<eTbl_NCHARColumns>()
            {
                //maybe find PK ...
                FieldName = eTbl_NCHARColumns.ID,
                Asc=false
            };
        }
        var order = OrderBys[0]!;
        IOrderedQueryable<Tbl_NCHAR> ret;
        //TODO: maybe utilize EF.Property ? 
        switch(order.FieldName){
                    case eTbl_NCHARColumns.ID:
                if(order.Asc)
                ...
                break;
                    ...
                    case eTbl_NCHARColumns.DataColumn:
                if(order.Asc)
                ...
                break;
                    ...
                    default:
                throw new ArgumentException(" cannot order Tbl_NCHAR by "+ order.FieldName);
    ...
    public override  IQueryable<Tbl_NCHAR> TransformToWhere(IQueryable<Tbl_NCHAR> data){
        if(SearchFields == null || SearchFields.Length ==0)        
            return data;
        var returnValue = data;
        foreach(var s in SearchFields){
            switch(s.FieldName ){
                case eTbl_NCHARColumns.None :
                    continue;
            ...
            case eTbl_NCHARColumns.ID:
                ...
                if(s.Value == null)
        {
                            throw new ArgumentException("Tbl_NCHAR.ID cannot be null");
