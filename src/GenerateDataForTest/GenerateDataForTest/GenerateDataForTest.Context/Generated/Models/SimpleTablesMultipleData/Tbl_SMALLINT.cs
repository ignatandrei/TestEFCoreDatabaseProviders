...
public partial class SearchTbl_SMALLINT:  GeneratorFromDB.Search<eTbl_SMALLINTColumns,Tbl_SMALLINT>
{
    //private SimpleTablesMultipleData _context;
    //public SearchTbl_SMALLINT(SimpleTablesMultipleData context){
    //    _context= context;
    //}
public static SearchTbl_SMALLINT FromSearch(GeneratorFromDB.SearchCriteria sc, eTbl_SMALLINTColumns colToSearch, string value)
    {
   ...
   public override IOrderedQueryable<Tbl_SMALLINT> TransformToOrder(IQueryable<Tbl_SMALLINT> data){
        if(OrderBys == null || OrderBys.Length ==0){
            OrderBys =new GeneratorFromDB.OrderBy<eTbl_SMALLINTColumns>[1];
            OrderBys[0]= new GeneratorFromDB.OrderBy<eTbl_SMALLINTColumns>()
            {
                //maybe find PK ...
                FieldName = eTbl_SMALLINTColumns.ID,
                Asc=false
            };
        }
        var order = OrderBys[0]!;
        IOrderedQueryable<Tbl_SMALLINT> ret;
        //TODO: maybe utilize EF.Property ? 
        switch(order.FieldName){
                    case eTbl_SMALLINTColumns.ID:
                if(order.Asc)
                ...
                break;
                    ...
                    case eTbl_SMALLINTColumns.DataColumn:
                if(order.Asc)
                ...
                break;
                    ...
                    default:
                throw new ArgumentException(" cannot order Tbl_SMALLINT by "+ order.FieldName);
    ...
    public override  IQueryable<Tbl_SMALLINT> TransformToWhere(IQueryable<Tbl_SMALLINT> data){
        if(SearchFields == null || SearchFields.Length ==0)        
            return data;
        var returnValue = data;
        foreach(var s in SearchFields){
            switch(s.FieldName ){
                case eTbl_SMALLINTColumns.None :
                    continue;
            ...
            case eTbl_SMALLINTColumns.ID:
                ...
                if(s.Value == null)
        {
                            throw new ArgumentException("Tbl_SMALLINT.ID cannot be null");
