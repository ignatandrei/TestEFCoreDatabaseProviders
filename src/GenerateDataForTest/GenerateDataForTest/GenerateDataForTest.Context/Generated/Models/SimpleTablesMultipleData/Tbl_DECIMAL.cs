...
public partial class SearchTbl_DECIMAL:  GeneratorFromDB.Search<eTbl_DECIMALColumns,Tbl_DECIMAL>
{
    //private SimpleTablesMultipleData _context;
    //public SearchTbl_DECIMAL(SimpleTablesMultipleData context){
    //    _context= context;
    //}
public static SearchTbl_DECIMAL FromSearch(GeneratorFromDB.SearchCriteria sc, eTbl_DECIMALColumns colToSearch, string value)
    {
   ...
   public override IOrderedQueryable<Tbl_DECIMAL> TransformToOrder(IQueryable<Tbl_DECIMAL> data){
        if(OrderBys == null || OrderBys.Length ==0){
            OrderBys =new GeneratorFromDB.OrderBy<eTbl_DECIMALColumns>[1];
            OrderBys[0]= new GeneratorFromDB.OrderBy<eTbl_DECIMALColumns>()
            {
                //maybe find PK ...
                FieldName = eTbl_DECIMALColumns.ID,
                Asc=false
            };
        }
        var order = OrderBys[0]!;
        IOrderedQueryable<Tbl_DECIMAL> ret;
        //TODO: maybe utilize EF.Property ? 
        switch(order.FieldName){
                    case eTbl_DECIMALColumns.ID:
                if(order.Asc)
                ...
                break;
                    ...
                    case eTbl_DECIMALColumns.DataColumn:
                if(order.Asc)
                ...
                break;
                    ...
                    default:
                throw new ArgumentException(" cannot order Tbl_DECIMAL by "+ order.FieldName);
    ...
    public override  IQueryable<Tbl_DECIMAL> TransformToWhere(IQueryable<Tbl_DECIMAL> data){
        if(SearchFields == null || SearchFields.Length ==0)        
            return data;
        var returnValue = data;
        foreach(var s in SearchFields){
            switch(s.FieldName ){
                case eTbl_DECIMALColumns.None :
                    continue;
            ...
            case eTbl_DECIMALColumns.ID:
                ...
                if(s.Value == null)
        {
                            throw new ArgumentException("Tbl_DECIMAL.ID cannot be null");
