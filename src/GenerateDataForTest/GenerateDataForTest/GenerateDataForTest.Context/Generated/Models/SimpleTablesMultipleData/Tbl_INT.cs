...
public partial class SearchTbl_INT:  GeneratorFromDB.Search<eTbl_INTColumns,Tbl_INT>
{
    //private SimpleTablesMultipleData _context;
    //public SearchTbl_INT(SimpleTablesMultipleData context){
    //    _context= context;
    //}
public static SearchTbl_INT FromSearch(GeneratorFromDB.SearchCriteria sc, eTbl_INTColumns colToSearch, string value)
    {
   ...
   public override IOrderedQueryable<Tbl_INT> TransformToOrder(IQueryable<Tbl_INT> data){
        if(OrderBys == null || OrderBys.Length ==0){
            OrderBys =new GeneratorFromDB.OrderBy<eTbl_INTColumns>[1];
            OrderBys[0]= new GeneratorFromDB.OrderBy<eTbl_INTColumns>()
            {
                //maybe find PK ...
                FieldName = eTbl_INTColumns.ID,
                Asc=false
            };
        }
        var order = OrderBys[0]!;
        IOrderedQueryable<Tbl_INT> ret;
        //TODO: maybe utilize EF.Property ? 
        switch(order.FieldName){
                    case eTbl_INTColumns.ID:
                if(order.Asc)
                ...
                break;
                    ...
                    case eTbl_INTColumns.DataColumn:
                if(order.Asc)
                ...
                break;
                    ...
                    default:
                throw new ArgumentException(" cannot order Tbl_INT by "+ order.FieldName);
    ...
    public override  IQueryable<Tbl_INT> TransformToWhere(IQueryable<Tbl_INT> data){
        if(SearchFields == null || SearchFields.Length ==0)        
            return data;
        var returnValue = data;
        foreach(var s in SearchFields){
            switch(s.FieldName ){
                case eTbl_INTColumns.None :
                    continue;
            ...
            case eTbl_INTColumns.ID:
                ...
                if(s.Value == null)
        {
                            throw new ArgumentException("Tbl_INT.ID cannot be null");
