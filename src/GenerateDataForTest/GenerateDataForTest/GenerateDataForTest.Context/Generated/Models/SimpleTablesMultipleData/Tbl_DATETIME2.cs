...
public partial class SearchTbl_DATETIME2:  GeneratorFromDB.Search<eTbl_DATETIME2Columns,Tbl_DATETIME2>
{
    //private SimpleTablesMultipleData _context;
    //public SearchTbl_DATETIME2(SimpleTablesMultipleData context){
    //    _context= context;
    //}
public static SearchTbl_DATETIME2 FromSearch(GeneratorFromDB.SearchCriteria sc, eTbl_DATETIME2Columns colToSearch, string value)
    {
   ...
   public override IOrderedQueryable<Tbl_DATETIME2> TransformToOrder(IQueryable<Tbl_DATETIME2> data){
        if(OrderBys == null || OrderBys.Length ==0){
            OrderBys =new GeneratorFromDB.OrderBy<eTbl_DATETIME2Columns>[1];
            OrderBys[0]= new GeneratorFromDB.OrderBy<eTbl_DATETIME2Columns>()
            {
                //maybe find PK ...
                FieldName = eTbl_DATETIME2Columns.ID,
                Asc=false
            };
        }
        var order = OrderBys[0]!;
        IOrderedQueryable<Tbl_DATETIME2> ret;
        //TODO: maybe utilize EF.Property ? 
        switch(order.FieldName){
                    case eTbl_DATETIME2Columns.ID:
                if(order.Asc)
                ...
                break;
                    ...
                    case eTbl_DATETIME2Columns.DataColumn:
                if(order.Asc)
                ...
                break;
                    ...
                    default:
                throw new ArgumentException(" cannot order Tbl_DATETIME2 by "+ order.FieldName);
    ...
    public override  IQueryable<Tbl_DATETIME2> TransformToWhere(IQueryable<Tbl_DATETIME2> data){
        if(SearchFields == null || SearchFields.Length ==0)        
            return data;
        var returnValue = data;
        foreach(var s in SearchFields){
            switch(s.FieldName ){
                case eTbl_DATETIME2Columns.None :
                    continue;
            ...
            case eTbl_DATETIME2Columns.ID:
                ...
                if(s.Value == null)
        {
                            throw new ArgumentException("Tbl_DATETIME2.ID cannot be null");
