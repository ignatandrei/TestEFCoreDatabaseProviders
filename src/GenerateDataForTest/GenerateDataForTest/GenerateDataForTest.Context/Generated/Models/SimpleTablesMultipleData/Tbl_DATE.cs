...
public partial class SearchTbl_DATE:  GeneratorFromDB.Search<eTbl_DATEColumns,Tbl_DATE>
{
    //private SimpleTablesMultipleData _context;
    //public SearchTbl_DATE(SimpleTablesMultipleData context){
    //    _context= context;
    //}
public static SearchTbl_DATE FromSearch(GeneratorFromDB.SearchCriteria sc, eTbl_DATEColumns colToSearch, string value)
    {
   ...
   public override IOrderedQueryable<Tbl_DATE> TransformToOrder(IQueryable<Tbl_DATE> data){
        if(OrderBys == null || OrderBys.Length ==0){
            OrderBys =new GeneratorFromDB.OrderBy<eTbl_DATEColumns>[1];
            OrderBys[0]= new GeneratorFromDB.OrderBy<eTbl_DATEColumns>()
            {
                //maybe find PK ...
                FieldName = eTbl_DATEColumns.ID,
                Asc=false
            };
        }
        var order = OrderBys[0]!;
        IOrderedQueryable<Tbl_DATE> ret;
        //TODO: maybe utilize EF.Property ? 
        switch(order.FieldName){
                    case eTbl_DATEColumns.ID:
                if(order.Asc)
                ...
                break;
                    ...
                    case eTbl_DATEColumns.DataColumn:
                if(order.Asc)
                ...
                break;
                    ...
                    default:
                throw new ArgumentException(" cannot order Tbl_DATE by "+ order.FieldName);
    ...
    public override  IQueryable<Tbl_DATE> TransformToWhere(IQueryable<Tbl_DATE> data){
        if(SearchFields == null || SearchFields.Length ==0)        
            return data;
        var returnValue = data;
        foreach(var s in SearchFields){
            switch(s.FieldName ){
                case eTbl_DATEColumns.None :
                    continue;
            ...
            case eTbl_DATEColumns.ID:
                ...
                if(s.Value == null)
        {
                            throw new ArgumentException("Tbl_DATE.ID cannot be null");
