...
export class ApplicationDBContext_Department_Table_Interaction {
    ...
    public getAllCount():Observable<number>{
        ...
        var data=this.http.get<number>(this.baseUrl+'AdvancedSearch_ApplicationDBContext_Department/GetAllCount')
          return data;
    }
    /*
...
export class TableData_Department implements OnInit
{
    ...
    constructor(private interaction:ApplicationDBContext_Department_Table_Interaction){
    }
      public dataTable:ApplicationDBContext_Department_Table[] | null = null;
      public dataTableFiltered:ApplicationDBContext_Department_Table[] | null = null;
      public  dataSource : MatTableDataSource<ApplicationDBContext_Department_Table> | null = null;
