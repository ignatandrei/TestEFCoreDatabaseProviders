...
export class SimpleTablesMultipleData_Tbl_NTEXT_Table_Interaction {
    ...
    public getAllCount():Observable<number>{
        ...
        var data=this.http.get<number>(this.baseUrl+'AdvancedSearch_SimpleTablesMultipleData_Tbl_NTEXT/GetAllCount')
          return data;
    }
    /*
...
@Component({
    selector: 'app-tabledata-Tbl_NTEXT',
    //templateUrl: './Tbl_NTEXT-gui.component.html',
...
<mat-header-row *matHeaderRowDef="columns"></mat-header-row>
    ...
    `,
    //styleUrls: ['./Tbl_NTEXT-gui.component.css']
  })

export class TableData_Tbl_NTEXT implements OnInit
{
    public nameTable = 'Tbl_NTEXT';
    public nameDB = 'SimpleTablesMultipleData';
    constructor(private interaction:SimpleTablesMultipleData_Tbl_NTEXT_Table_Interaction){
    }
      public dataTable:SimpleTablesMultipleData_Tbl_NTEXT_Table[] | null = null;
      public dataTableFiltered:SimpleTablesMultipleData_Tbl_NTEXT_Table[] | null = null;
      public  dataSource : MatTableDataSource<SimpleTablesMultipleData_Tbl_NTEXT_Table> | null = null;
