...
export class SimpleTablesMultipleData_Tbl_HIERARCHYID_Table_Interaction {
    ...
    public getAllCount():Observable<number>{
        ...
        var data=this.http.get<number>(this.baseUrl+'AdvancedSearch_SimpleTablesMultipleData_Tbl_HIERARCHYID/GetAllCount')
          return data;
    }
    /*
...
@Component({
    selector: 'app-tabledata-Tbl_HIERARCHYID',
    //templateUrl: './Tbl_HIERARCHYID-gui.component.html',
...
<mat-header-row *matHeaderRowDef="columns"></mat-header-row>
    ...
    `,
    //styleUrls: ['./Tbl_HIERARCHYID-gui.component.css']
  })

export class TableData_Tbl_HIERARCHYID implements OnInit
{
    public nameTable = 'Tbl_HIERARCHYID';
    public nameDB = 'SimpleTablesMultipleData';
    constructor(private interaction:SimpleTablesMultipleData_Tbl_HIERARCHYID_Table_Interaction){
    }
      public dataTable:SimpleTablesMultipleData_Tbl_HIERARCHYID_Table[] | null = null;
      public dataTableFiltered:SimpleTablesMultipleData_Tbl_HIERARCHYID_Table[] | null = null;
      public  dataSource : MatTableDataSource<SimpleTablesMultipleData_Tbl_HIERARCHYID_Table> | null = null;
