...
export class ApplicationDBContext_test_Table_Interaction {
    ...
    public getAllCount():Observable<number>{
        ...
        var data=ajax.getJSON(this.baseUrl+'AdvancedSearch_ApplicationDBContext_test/GetAllCount')
        .pipe(
            map(response => {
...
export default function TableData_test() 
{
    ...
    const interaction=new ApplicationDBContext_test_Table_Interaction();
    const [dataTable,setDataTable]= useState<ApplicationDBContext_test_Table[]|null>(null);
const [dataTableFiltered, setDataTableFiltered] = useState<ApplicationDBContext_test_Table[] | null>(null);
    
const columns : ColumnsType<ApplicationDBContext_test_Table> =[
    {
        title: 'ID',
        dataIndex: 'id',
        key: 'id',
        width: '5%',
        render:(item: any, record: ApplicationDBContext_test_Table, index: any)=>(<>{index+1}</>)
      }
    ...
    dataIndex: 'id',
    key: 'id',
    sorter: (a:ApplicationDBContext_test_Table, b:ApplicationDBContext_test_Table) => 
    {
