...
export class SimpleTablesMultipleData_Tbl_IMAGE_Table_Interaction {
    ...
    public getAllCount():Observable<number>{
        ...
        var data=ajax.getJSON(this.baseUrl+'AdvancedSearch_SimpleTablesMultipleData_Tbl_IMAGE/GetAllCount')
        .pipe(
            map(response => {
...
export default function TableData_Tbl_IMAGE() 
{
    const nameTable = 'Tbl_IMAGE';
    const nameDB = 'SimpleTablesMultipleData';
    const [loading,setLoading]= useState<boolean>(false);
    const [showAll, searchSimpleData]=useSearchURL();
    
    const interaction=new SimpleTablesMultipleData_Tbl_IMAGE_Table_Interaction();
    const [dataTable,setDataTable]= useState<SimpleTablesMultipleData_Tbl_IMAGE_Table[]|null>(null);
const [dataTableFiltered, setDataTableFiltered] = useState<SimpleTablesMultipleData_Tbl_IMAGE_Table[] | null>(null);
    
const columns : ColumnsType<SimpleTablesMultipleData_Tbl_IMAGE_Table> =[
    {
        title: 'ID',
        dataIndex: 'id',
        key: 'id',
        width: '5%',
        render:(item: any, record: SimpleTablesMultipleData_Tbl_IMAGE_Table, index: any)=>(<>{index+1}</>)
      }
    ...
    dataIndex: 'id',
    key: 'id',
    sorter: (a:SimpleTablesMultipleData_Tbl_IMAGE_Table, b:SimpleTablesMultipleData_Tbl_IMAGE_Table) => 
    {
